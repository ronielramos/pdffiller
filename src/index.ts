...
class pdffiller {
  ...
  public mapForm2PDF (formFields: { [key: string]: string } | { [key: string]: string }[], convMap: { [key: string]: unknown }) {
  ...
  public convFieldJson2FDF (fieldJson: { [key: string]: string } | { [key: string]: string }[]) {
  ...
  public generateFieldJson (sourceFile: string, nameRegex: string | null, callback: Function) {
  ...
  public generateFDFTemplate (sourceFile: string, nameRegex: string | null, callback: Function) {
